package xyz.needpainkiller.core.api;
...
public abstract class CommonController {
    ...
    protected static final String KEY_MENU_LIST = "menuList";
    protected static final String KEY_API_LIST = "apiList";
    protected static final String KEY_PUBLIC_API_LIST = "publicApiList";
